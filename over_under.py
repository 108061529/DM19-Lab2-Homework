# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 21:38:49 2019
...
#%%
#n = 412614
sampling_strategy = {'joy':412614,
                     'trust':164376*2,
                     'anticipation':199266*2,
                     'sadness':154590*2,
                     'disgust':111336*2,
                     'fear':51355*2,
                     'surprise':39022*2,
...
csv_logger = CSVLogger('logs/over_under_train_lstm.csv')
print('Train...')
...
#%%
model.save('models/lstm_model_train_tweets_over_under.h5')
#%%
