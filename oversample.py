...
#%%
n = 412614
sampling_strategy = {'joy':int(n*1),
                     'trust':int(n*0.7),
                     'anticipation':int(n*0.7),
                     'sadness':int(n*0.7),
                     'disgust':int(n*0.7),
                     'fear':int(n*0.7),
                     'surprise':int(n*0.7),
...
csv_logger = CSVLogger('logs/balance_train_lstm.csv')
print('Train...')
...
#%%
model.save('models/lstm_model_train_tweets_balance_07.h5')
#%%
