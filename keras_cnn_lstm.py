...
csv_logger = CSVLogger('logs/balance_train_cnn_lstm.csv')
print('Train...')
...
#%%
model.save('models/cnn_lstm_model_train_tweets.h5')
#%%
#import matplotlib.pyplot as plt
#training_log = pd.read_csv('logs/balance_train_cnn_lstm.csv')
